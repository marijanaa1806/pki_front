...
const Cakes = () => {
  ...
  const slideImages = [
    ...
    { name: 'Cheesecake', src: 'cheesecake.jpg',about:' Prepustite se kremastoj eleganciji našeg kolača od sira, gde se baršunasta mešavina krem sira, jaja i šećera delikatno peče do savršenstva, stvarajući nebeski desert koji se topi u ustima.', price:'250',ingredients:'jaja, secer, voda, brasno, bogata dobrota krem sira,maline.',torta:1 },
    { name: 'Vocna torta', src: 't2.jfif',about: 'Doživite žarki ples ukusa uz našu tortu od limete i kivija. Oštre note limete i tropske slatkoće kivija spajaju se u harmoničnu fuziju, čineći svaku krišku osvežavajućim užitkom.', price:'250',ingredients:'jaja, secer, voda, brasno,limeta,kivi',torta:1 },
    ...
    { name: 'Cokolada torta', src: 'choko.jpeg' ,about:'Prepustite se dekadenciji naše čokoladne torte. Bogat kakao u kombinaciji sa baršunastim testom stvara vlažan i ugodan doživljaj, čineći ga istinskim slavljem za ljubitelje čokolade.', price:'250',ingredients:'jaja, secer, voda, brasno,cokolada',torta:1},
  ...
  const slideImages2 = [
    { name: 'Cokoladni mafin', src: "cc.jpg",about:'Ovaj čokoladni mafin osvaja svojom bogatom čokoladnom notom i mekanom teksturom. Savršen je za ljubitelje čokolade koji žele uživati u ukusnom zalogaju.', price:'250',ingredients:'jaja, secer, voda, brasno',torta:0 },
    { name: 'Sareni mafin', src:  "ck.jpg",about:'Sareni mafin donosi radost boja i ukusa. Svaki zalogaj je šareno iskustvo, savršeno za sve koji vole veselje i raznolikost', price:'150',ingredients:'jaja, secer, voda, brasno',torta:0 },
